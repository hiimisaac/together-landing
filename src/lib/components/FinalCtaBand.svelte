...
<section id="final-cta" class="section" aria-label="Get started">
  <div class="container">
...
<style>
  .cta-band {
    ...
    text-align: center;
    background: linear-gradient(130deg, rgba(31, 122, 93, 0.14), rgba(59, 130, 246, 0.16), rgba(255, 255, 255, 0.98));
  }
